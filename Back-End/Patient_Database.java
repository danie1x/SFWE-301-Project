...
public class Patient_Database {
    ...
    private static final String TEMP_FILE_PATH = "Back-End/temp_patient_database.csv";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// 
/// Methods
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Simple Method for testing a dummy Patient
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // BACK-END TEST 1
    public static void backEndTest1() {
        // Add a Patient
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // BACK-END TEST 3
    public static void backEndTest3(){
        // Add a Patient
        String testName = "Jane";
        Patient plainJane = new Patient("Jane", 
                                         "01/01/1980",
        ...
        Patient foundPatient = findPatientByName(testName);
        if (foundPatient != null) {
            System.out.println("Database contains " + testName + " record. email: " + (foundPatient.getEmail()));
        } else {
            System.out.println("Database does not contain " + testName + " record");
        }

        // Attempt to change the email
        plainJane.setEmail("jFonda@catmail.com", false);
        modifyPatient(testName, plainJane);
        foundPatient = findPatientByName(testName);

        // Reattempt to change the email
        plainJane.setEmail("jFonda@catmail.com", true);
        modifyPatient(testName, plainJane);
        foundPatient = findPatientByName(testName);
        if (foundPatient != null) {
            System.out.println("Database contains " + testName + " record. email: " + (foundPatient.getEmail()));
